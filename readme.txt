...
Step-2: Select the denoising method as required. The completion of processing will be displayed in the adjacent text box. 
...
Step-3: Enter the values (in mm) for the slice in-plane resolution, slice-gap for isotropic voxelization and 
        ...
        Then press the 'Prepare Volume' button. The completion of processing will be displayed in the adjacent text box. 

Step-4: Select the Texture analysis methods to evaluate the features. The completion of processing will be displayed in the adjacent text box.
