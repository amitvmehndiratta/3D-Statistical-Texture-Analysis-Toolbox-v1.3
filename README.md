...
Texture_Analysis_Toolbox Executable : Please dowlload it [https://csciitd-my.sharepoint.com/:f:/g/personal/amehndiratta_iitd_ac_in/IgD6ppeLYpLoQIlAyF15dKiwAeVUzFHNZVXAk3-q3P7VeI4?e=vNc5Ze]
...
- Please double click the Texture_Analysis_Toolbox_Installer.exe file and follow the instruction to install the texture analysis tool.
  ...
  Note: Version 9.4 (R2018a) of the MATLAB Runtime will be installed following software Texture_Analysis_Toolbox_v1.3 (already included in this exe).
